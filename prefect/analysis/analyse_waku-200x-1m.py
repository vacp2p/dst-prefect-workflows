...
if __name__ == '__main__':
    ...
    timestamp = "[2025-03-27 12:13:34, 2025-03-27 12:14:42]"
    stateful_sets = ["bootstrap", "nodes"] if "waku" == "waku" else ["nodes"]
    # Example of data analysis from cluster
    log_analyzer = WakuMessageLogAnalyzer(stateful_sets, timestamp, dump_analysis_dir='local_data/waku-200x-1m/')
